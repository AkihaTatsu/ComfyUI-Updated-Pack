...
class Mesh_Graphormer_Depth_Map_Preprocessor_UpdatedPack:
    @classmethod
    def INPUT_TYPES(s):
    ...
    CATEGORY = "Updated Pack/ControlNet Preprocessors/Normal and Depth Estimators"
...
class Mesh_Graphormer_With_ImpactDetector_Depth_Map_Preprocessor_UpdatedPack:
    @classmethod
    def INPUT_TYPES(s):
    ...
    def execute(self, image, bbox_detector, bbox_threshold=0.5, bbox_dilation=10, bbox_crop_factor=3.0, drop_size=10, resolution=512, **mesh_graphormer_kwargs):
        install_deps()
        from custom_controlnet_aux.mesh_graphormer import MeshGraphormerDetector
        mesh_graphormer_node = Mesh_Graphormer_Depth_Map_Preprocessor_UpdatedPack()
...
NODE_CLASS_MAPPINGS = {
    "MeshGraphormer-DepthMapPreprocessor_UpdatedPack": Mesh_Graphormer_Depth_Map_Preprocessor_UpdatedPack,
    "MeshGraphormer+ImpactDetector-DepthMapPreprocessor_UpdatedPack": Mesh_Graphormer_With_ImpactDetector_Depth_Map_Preprocessor_UpdatedPack
}
