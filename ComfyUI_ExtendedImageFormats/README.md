...
For avif support install `pillow-avif-plugin` to your venv. JXL support is detected automatically from Pillow's available codecs.

`jxlpy` is intentionally not used in this pack due to compatibility issues on some systems.
```
